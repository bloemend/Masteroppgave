...
\begin{itemize}
\item How can the Mesh Potato be used in different an emergency situations?
\item How can an emergency box be developed? What components, set-ups and configurations are necessary?
\item Look at different situations where there is a need for a go-box. What are the different needs in the different situations?
\item Look at the process of quick roll out. What measures can we do in advance to make it as easy and fast as possible to connect the go-box to and internet connection.
\end{itemize}
