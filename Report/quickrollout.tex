...
The web interface allows the user to do alterations in the MP in an easy and userfriendly interface. A newly flashed MP does not have the root password set, and when entering the web interface the user will not be asked to enter a password for authentication. This is a feature recommended to set up.  The web interface allows the user to alter some key parameters. Among these are Network configurations, WiFi Access Point, VoIP/SIP Configurations, Password and Web Server Security. 
