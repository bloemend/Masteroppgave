...
Different methods of distributing Internet is always under development. The previous up-links described is well established, but in many parts of the world not fully developed or not affordable to the average person. The large technology companies, like Apple and Google, are experimenting with different ways of distributing Internet. Although none of the solutions described below are an option for distributing Internet as of today, it could be a good option in the near future. Both these solution are affordable and well compatible with our emergency box solution. 
