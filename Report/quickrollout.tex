...
\subsection{Our box}
We want to make an emergency box that has high adaptability, so it can be utilized in several different scenarios. The components of our emergency box is described in \tref{tab:components}. All the calculations done in this section is based on the equipment described in \tref{tab:components}.
