...
\begin{figure}[h!]
  \centering
    \includegraphics[width=1\textwidth]{adhocprotocols.png}
     \caption[Ad Hoc Routing Protocols]{Different groups of ad hoc routing protocols \cite{adhoc}.}
...
\begin{figure}[h!]
  \centering
    \includegraphics[width=0.8\textwidth]{batman.png}
     \caption[Originator Message in B.A.T.M.A.N]{Originator Message used in B.A.T.M.A.N \cite{batman2}.}
\label{fig:batman} 
\end{figure}
